...
Last time rendered: 14:30 - 17. Oct 2022 by user runner
...
#> * checking for file ‘/tmp/Rtmpi9jvpE/remotesdceb3ef2c555/datashield-dsBaseClient-5bdd61a/DESCRIPTION’ ... OK
...
#> * checking for file ‘/tmp/Rtmpi9jvpE/remotesdceb5d4bf788/difuture-lmu-dsPredictBase-8266eff/DESCRIPTION’ ... OK
...
#> * checking for file ‘/tmp/Rtmpi9jvpE/remotesdceb4fd3acb8/difuture-lmu-dsCalibration-1805632/DESCRIPTION’ ... OK
...
#> * checking for file ‘/tmp/Rtmpi9jvpE/remotesdceb6aa467f4/difuture-lmu-dsROCGLM-3c2c43f/DESCRIPTION’ ... OK
#> * preparing ‘dsROCGLM’:
#> * checking DESCRIPTION meta-information ... OK
#> * checking for LF line-endings in source and make files and shell scripts
#> * checking for empty or unneeded directories
...
#> [2022-10-17 14:35:14] Your object is bigger than 1 MB (14.4 MB). Uploading larger objects may take some time.
(t0 = proc.time() - t0)
#>    user  system elapsed 
#> 106.429  48.719 765.710
datashield.symbols(conn)
#> $ds1
#> [1] "D"   "mod"
#> 
...
#> 
#> [2022-10-17 14:48:25] L2 sensitivity is: 0.016
#> 
#> [2022-10-17 14:48:27] Setting: epsilon = 0.3 and delta = 0.4
#> 
#> [2022-10-17 14:48:27] Initializing ROC-GLM
#> 
#> [2022-10-17 14:48:27] Host: Received scores of negative response
#> [2022-10-17 14:48:27] Receiving negative scores
#> [2022-10-17 14:48:29] Host: Pushing pooled scores
#> [2022-10-17 14:48:31] Server: Calculating placement values and parts for ROC-GLM
#> [2022-10-17 14:48:33] Server: Calculating probit regression to obtain ROC-GLM
#> [2022-10-17 14:48:35] Deviance of iter1=32.6342
#> [2022-10-17 14:48:37] Deviance of iter2=41.5111
#> [2022-10-17 14:48:39] Deviance of iter3=46.5649
#> [2022-10-17 14:48:41] Deviance of iter4=46.8714
#> [2022-10-17 14:48:43] Deviance of iter5=46.8724
#> [2022-10-17 14:48:45] Deviance of iter6=46.8724
#> [2022-10-17 14:48:45] Host: Finished calculating ROC-GLM
#> [2022-10-17 14:48:45] Host: Cleaning data on server
#> [2022-10-17 14:48:48] Host: Calculating AUC and CI
#> [2022-10-17 14:49:02] Finished!
...
#> [10] ggplot2_3.3.6       opalr_3.2.0         httr_1.4.4         
#> 
...
#> [13] backports_1.4.1   labelled_2.10.0   evaluate_0.17     highr_0.9        
#> [17] pillar_1.8.1      rlang_1.0.6       curl_4.3.3        extrafontdb_1.0  
#> [21] callr_3.7.2       Matrix_1.4-1      checkmate_2.1.0   rmarkdown_2.17   
#> [25] labeling_0.4.2    splines_4.2.1     extrafont_0.18    stringr_1.4.1    
#> [29] munsell_0.5.0     compiler_4.2.1    xfun_0.33         pkgconfig_2.0.3  
#> [33] pkgbuild_1.3.1    htmltools_0.5.3   tidyselect_1.2.0  tibble_3.1.8     
#> [37] fansi_1.0.3       crayon_1.5.2      dplyr_1.0.10      withr_2.5.0      
#> [41] MASS_7.3-57       grid_4.2.1        jsonlite_1.8.2    Rttf2pt1_1.3.11  
#> [45] gtable_0.3.1      lifecycle_1.0.3   magrittr_2.0.3    pROC_1.18.0      
...
#> [61] hms_1.1.2         processx_3.7.0    fastmap_1.1.0     survival_3.3-1   
#> [65] yaml_2.3.5        colorspace_2.0-3  knitr_1.40        haven_2.5.1
```
