...
Last time rendered: 13:55 - 16. Jan 2023 by user runner
...
#> ── R CMD build ─────────────────────────────────────────────────────────────────
#> * checking for file ‘/tmp/Rtmp7rDbaE/remotesca2a3d74dd72/datashield-dsBaseClient-182a814/DESCRIPTION’ ... OK
...
#> ── R CMD build ─────────────────────────────────────────────────────────────────
#> * checking for file ‘/tmp/Rtmp7rDbaE/remotesca2a52df2231/difuture-lmu-dsPredictBase-8266eff/DESCRIPTION’ ... OK
...
#> ── R CMD build ─────────────────────────────────────────────────────────────────
#> * checking for file ‘/tmp/Rtmp7rDbaE/remotesca2a782c9120/difuture-lmu-dsCalibration-1805632/DESCRIPTION’ ... OK
...
#> ── R CMD build ─────────────────────────────────────────────────────────────────
#> * checking for file ‘/tmp/Rtmp7rDbaE/remotesca2a6068d082/difuture-lmu-dsROCGLM-3c2c43f/DESCRIPTION’ ... OK
#> * preparing ‘dsROCGLM’:
#> * checking DESCRIPTION meta-information ... OK
#> * checking for LF line-endings in source and make files and shell scripts
#> * checking for empty or unneeded directories
...
#> [2023-01-16 14:02:00] Your object is bigger than 1 MB (14.4 MB). Uploading larger objects may take some time.
(t0 = proc.time() - t0)
#>    user  system elapsed 
#>  35.965   0.432 778.383
datashield.symbols(conn)
#> $ds1
#> [1] "D"   "mod"
#> 
...
#> 
#> [2023-01-16 14:15:37] L2 sensitivity is: 0.016
#> 
#> [2023-01-16 14:15:41] Setting: epsilon = 0.3 and delta = 0.4
#> 
#> [2023-01-16 14:15:41] Initializing ROC-GLM
#> 
#> [2023-01-16 14:15:41] Host: Received scores of negative response
#> [2023-01-16 14:15:41] Receiving negative scores
#> [2023-01-16 14:15:44] Host: Pushing pooled scores
#> [2023-01-16 14:15:47] Server: Calculating placement values and parts for ROC-GLM
#> [2023-01-16 14:15:50] Server: Calculating probit regression to obtain ROC-GLM
#> [2023-01-16 14:15:53] Deviance of iter1=32.6342
#> [2023-01-16 14:15:57] Deviance of iter2=41.5111
#> [2023-01-16 14:16:00] Deviance of iter3=46.5649
#> [2023-01-16 14:16:03] Deviance of iter4=46.8714
#> [2023-01-16 14:16:06] Deviance of iter5=46.8724
#> [2023-01-16 14:16:09] Deviance of iter6=46.8724
#> [2023-01-16 14:16:09] Host: Finished calculating ROC-GLM
#> [2023-01-16 14:16:09] Host: Cleaning data on server
#> [2023-01-16 14:16:12] Host: Calculating AUC and CI
#> [2023-01-16 14:16:34] Finished!
...
#> [13] backports_1.4.1   labelled_2.10.0   evaluate_0.19     highr_0.10       
...
#> [57] vctrs_0.5.1       TH.data_1.1-1     tools_4.2.2       forcats_0.5.2    
