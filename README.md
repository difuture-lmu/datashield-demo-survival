...
<!-- README.md is generated from README.Rmd. Please edit that file -->
    ...
    ## Install package ds.predict.base 
    ##   Done!
    ## Install package ds.calibration 
    ##   Done!
    ## Install package ds.roc.glm 
    ##   Done!
...
#> Skipping install of 'ds.calibration' from a github remote, the SHA1 (961ff09e) has not changed since last install.
#>   Use `force = TRUE` to force installation
...
#> [2022-02-09 23:23:22] Your object is bigger than 1 MB (7.1 MB). Uploading larger objects may take some time.
...
#> 
#> [2022-02-09 23:26:26] Initializing ROC-GLM
#> 
#> [2022-02-09 23:26:26] Host: Received scores of negative response
#> [2022-02-09 23:26:26] Calculating standard deviation of differences
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getNegativeScoresVar("D$cens", "probs", 4)) [----------------------------]   0% / 0s  Getting aggregate ds1 (getNegativeScoresVar("D$cens", "probs", 4)) [==>----------------]  17% / 0s  Checking ds2 (getNegativeScoresVar("D$cens", "probs", 4)) [====>-----------------------]  17% / 0s  Getting aggregate ds2 (getNegativeScoresVar("D$cens", "probs", 4)) [=====>-------------]  33% / 0s  Checking ds3 (getNegativeScoresVar("D$cens", "probs", 4)) [========>-------------------]  33% / 0s  Getting aggregate ds3 (getNegativeScoresVar("D$cens", "probs", 4)) [=========>---------]  50% / 0s  Checking ds4 (getNegativeScoresVar("D$cens", "probs", 4)) [=============>--------------]  50% / 1s  Getting aggregate ds4 (getNegativeScoresVar("D$cens", "probs", 4)) [============>------]  67% / 1s  Checking ds5 (getNegativeScoresVar("D$cens", "probs", 4)) [==================>---------]  67% / 1s  Getting aggregate ds5 (getNegativeScoresVar("D$cens", "probs", 4)) [===============>---]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
...
#> [2022-02-09 23:26:28] Receiving negative scores
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getNegativeScores("D$cens", "probs", 0.0330825657648068, 2)) [-----------]   0% / 0s  Getting aggregate ds1 (getNegativeScores("D$cens", "probs", 0.0330825657648068, 2)) [--]  17% / 0s  Checking ds2 (getNegativeScores("D$cens", "probs", 0.0330825657648068, 2)) [=>---------]  17% / 0s  Getting aggregate ds2 (getNegativeScores("D$cens", "probs", 0.0330825657648068, 2)) [>-]  33% / 0s  Checking ds3 (getNegativeScores("D$cens", "probs", 0.0330825657648068, 2)) [===>-------]  33% / 0s  Getting aggregate ds3 (getNegativeScores("D$cens", "probs", 0.0330825657648068, 2)) [>-]  50% / 1s  Checking ds4 (getNegativeScores("D$cens", "probs", 0.0330825657648068, 2)) [=====>-----]  50% / 1s  Getting aggregate ds4 (getNegativeScores("D$cens", "probs", 0.0330825657648068, 2)) [>-]  67% / 1s  Checking ds5 (getNegativeScores("D$cens", "probs", 0.0330825657648068, 2)) [======>----]  67% / 1s  Getting aggregate ds5 (getNegativeScores("D$cens", "probs", 0.0330825657648068, 2)) [=>]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#> [2022-02-09 23:26:29] Host: Pushing pooled scores
...
#> [2022-02-09 23:26:30] Server: Calculating placement values and parts for ROC-GLM
...
#> [2022-02-09 23:26:31] Server: Calculating probit regression to obtain ROC-GLM
...
#> [2022-02-09 23:26:32] Deviance of iter1=52.6631
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-09 23:26:33] Deviance of iter2=73.4241
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-09 23:26:34] Deviance of iter3=81.0736
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-09 23:26:35] Deviance of iter4=81.3374
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-09 23:26:36] Deviance of iter5=81.3377
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-09 23:26:37] Deviance of iter6=81.3377
#> [2022-02-09 23:26:37] Host: Finished calculating ROC-GLM
#> [2022-02-09 23:26:37] Host: Cleaning data on server
#> [2022-02-09 23:26:39] Host: Calculating AUC and CI
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (meanDS(D$cens)) [--------------------------------------------------------]   0% / 0s  Getting aggregate ds1 (meanDS(D$cens)) [=======>---------------------------------------]  17% / 0s  Checking ds2 (meanDS(D$cens)) [========>-----------------------------------------------]  17% / 0s  Getting aggregate ds2 (meanDS(D$cens)) [===============>-------------------------------]  33% / 0s  Checking ds3 (meanDS(D$cens)) [==================>-------------------------------------]  33% / 1s  Getting aggregate ds3 (meanDS(D$cens)) [=======================>-----------------------]  50% / 1s  Checking ds4 (meanDS(D$cens)) [===========================>----------------------------]  50% / 1s  Getting aggregate ds4 (meanDS(D$cens)) [==============================>----------------]  67% / 1s  Checking ds5 (meanDS(D$cens)) [====================================>-------------------]  67% / 1s  Getting aggregate ds5 (meanDS(D$cens)) [======================================>--------]  83% / 1s  Aggregated (meanDS(D$cens)) [==========================================================] 100% / 1s
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getNegativeScoresVar("D$cens", "probs", 4)) [----------------------------]   0% / 0s  Getting aggregate ds1 (getNegativeScoresVar("D$cens", "probs", 4)) [==>----------------]  17% / 0s  Checking ds2 (getNegativeScoresVar("D$cens", "probs", 4)) [====>-----------------------]  17% / 0s  Getting aggregate ds2 (getNegativeScoresVar("D$cens", "probs", 4)) [=====>-------------]  33% / 0s  Checking ds3 (getNegativeScoresVar("D$cens", "probs", 4)) [========>-------------------]  33% / 1s  Getting aggregate ds3 (getNegativeScoresVar("D$cens", "probs", 4)) [=========>---------]  50% / 1s  Checking ds4 (getNegativeScoresVar("D$cens", "probs", 4)) [=============>--------------]  50% / 1s  Getting aggregate ds4 (getNegativeScoresVar("D$cens", "probs", 4)) [============>------]  67% / 1s  Checking ds5 (getNegativeScoresVar("D$cens", "probs", 4)) [==================>---------]  67% / 1s  Getting aggregate ds5 (getNegativeScoresVar("D$cens", "probs", 4)) [===============>---]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
...
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getNegativeScores("D$cens", "probs", 0.0576516863955995, 2)) [-----------]   0% / 0s  Getting aggregate ds1 (getNegativeScores("D$cens", "probs", 0.0576516863955995, 2)) [--]  17% / 0s  Checking ds2 (getNegativeScores("D$cens", "probs", 0.0576516863955995, 2)) [=>---------]  17% / 0s  Getting aggregate ds2 (getNegativeScores("D$cens", "probs", 0.0576516863955995, 2)) [>-]  33% / 0s  Checking ds3 (getNegativeScores("D$cens", "probs", 0.0576516863955995, 2)) [===>-------]  33% / 1s  Getting aggregate ds3 (getNegativeScores("D$cens", "probs", 0.0576516863955995, 2)) [>-]  50% / 1s  Checking ds4 (getNegativeScores("D$cens", "probs", 0.0576516863955995, 2)) [=====>-----]  50% / 1s  Getting aggregate ds4 (getNegativeScores("D$cens", "probs", 0.0576516863955995, 2)) [>-]  67% / 1s  Checking ds5 (getNegativeScores("D$cens", "probs", 0.0576516863955995, 2)) [======>----]  67% / 1s  Getting aggregate ds5 (getNegativeScores("D$cens", "probs", 0.0576516863955995, 2)) [=>]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getPositiveScores("D$cens", "probs", 0.0563072787549756, 2)) [-----------]   0% / 0s  Getting aggregate ds1 (getPositiveScores("D$cens", "probs", 0.0563072787549756, 2)) [--]  17% / 0s  Checking ds2 (getPositiveScores("D$cens", "probs", 0.0563072787549756, 2)) [=>---------]  17% / 0s  Getting aggregate ds2 (getPositiveScores("D$cens", "probs", 0.0563072787549756, 2)) [>-]  33% / 0s  Checking ds3 (getPositiveScores("D$cens", "probs", 0.0563072787549756, 2)) [===>-------]  33% / 1s  Getting aggregate ds3 (getPositiveScores("D$cens", "probs", 0.0563072787549756, 2)) [>-]  50% / 1s  Checking ds4 (getPositiveScores("D$cens", "probs", 0.0563072787549756, 2)) [=====>-----]  50% / 1s  Getting aggregate ds4 (getPositiveScores("D$cens", "probs", 0.0563072787549756, 2)) [>-]  67% / 1s  Checking ds5 (getPositiveScores("D$cens", "probs", 0.0563072787549756, 2)) [======>----]  67% / 1s  Getting aggregate ds5 (getPositiveScores("D$cens", "probs", 0.0563072787549756, 2)) [=>]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#> [2022-02-09 23:26:44] Finished!
