...
#> [2022-02-09 23:58:17] Your object is bigger than 1 MB (7.1 MB). Uploading larger objects may take some time.
...
#> 
#> [2022-02-10 00:01:21] Initializing ROC-GLM
#> 
#> [2022-02-10 00:01:21] Host: Received scores of negative response
#> [2022-02-10 00:01:21] Calculating standard deviation of differences
...
#> [2022-02-10 00:01:23] Receiving negative scores
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getNegativeScores("D$cens", "probs", 0.0306395105255389, 2)) [-----------]   0% / 0s  Getting aggregate ds1 (getNegativeScores("D$cens", "probs", 0.0306395105255389, 2)) [--]  17% / 0s  Checking ds2 (getNegativeScores("D$cens", "probs", 0.0306395105255389, 2)) [=>---------]  17% / 0s  Getting aggregate ds2 (getNegativeScores("D$cens", "probs", 0.0306395105255389, 2)) [>-]  33% / 0s  Checking ds3 (getNegativeScores("D$cens", "probs", 0.0306395105255389, 2)) [===>-------]  33% / 1s  Getting aggregate ds3 (getNegativeScores("D$cens", "probs", 0.0306395105255389, 2)) [>-]  50% / 1s  Checking ds4 (getNegativeScores("D$cens", "probs", 0.0306395105255389, 2)) [=====>-----]  50% / 1s  Getting aggregate ds4 (getNegativeScores("D$cens", "probs", 0.0306395105255389, 2)) [>-]  67% / 1s  Checking ds5 (getNegativeScores("D$cens", "probs", 0.0306395105255389, 2)) [======>----]  67% / 1s  Getting aggregate ds5 (getNegativeScores("D$cens", "probs", 0.0306395105255389, 2)) [=>]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#> [2022-02-10 00:01:24] Host: Pushing pooled scores
...
#> [2022-02-10 00:01:25] Server: Calculating placement values and parts for ROC-GLM
...
#> [2022-02-10 00:01:26] Server: Calculating probit regression to obtain ROC-GLM
...
#> [2022-02-10 00:01:27] Deviance of iter1=52.6631
...
#> [2022-02-10 00:01:28] Deviance of iter2=74.7049
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-10 00:01:28] Deviance of iter3=83.9938
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-10 00:01:29] Deviance of iter4=84.4104
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-10 00:01:30] Deviance of iter5=84.4112
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 0s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-10 00:01:31] Deviance of iter6=84.4112
#> [2022-02-10 00:01:31] Host: Finished calculating ROC-GLM
#> [2022-02-10 00:01:31] Host: Cleaning data on server
#> [2022-02-10 00:01:34] Host: Calculating AUC and CI
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (meanDS(D$cens)) [--------------------------------------------------------]   0% / 0s  Getting aggregate ds1 (meanDS(D$cens)) [=======>---------------------------------------]  17% / 0s  Checking ds2 (meanDS(D$cens)) [========>-----------------------------------------------]  17% / 0s  Getting aggregate ds2 (meanDS(D$cens)) [===============>-------------------------------]  33% / 0s  Checking ds3 (meanDS(D$cens)) [==================>-------------------------------------]  33% / 1s  Getting aggregate ds3 (meanDS(D$cens)) [=======================>-----------------------]  50% / 1s  Checking ds4 (meanDS(D$cens)) [===========================>----------------------------]  50% / 1s  Getting aggregate ds4 (meanDS(D$cens)) [==============================>----------------]  67% / 1s  Checking ds5 (meanDS(D$cens)) [====================================>-------------------]  67% / 1s  Getting aggregate ds5 (meanDS(D$cens)) [======================================>--------]  83% / 1s  Aggregated (meanDS(D$cens)) [==========================================================] 100% / 1s
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getNegativeScoresVar("D$cens", "probs", 4)) [----------------------------]   0% / 0s  Getting aggregate ds1 (getNegativeScoresVar("D$cens", "probs", 4)) [==>----------------]  17% / 0s  Checking ds2 (getNegativeScoresVar("D$cens", "probs", 4)) [====>-----------------------]  17% / 0s  Getting aggregate ds2 (getNegativeScoresVar("D$cens", "probs", 4)) [=====>-------------]  33% / 0s  Checking ds3 (getNegativeScoresVar("D$cens", "probs", 4)) [========>-------------------]  33% / 0s  Getting aggregate ds3 (getNegativeScoresVar("D$cens", "probs", 4)) [=========>---------]  50% / 1s  Checking ds4 (getNegativeScoresVar("D$cens", "probs", 4)) [=============>--------------]  50% / 1s  Getting aggregate ds4 (getNegativeScoresVar("D$cens", "probs", 4)) [============>------]  67% / 1s  Checking ds5 (getNegativeScoresVar("D$cens", "probs", 4)) [==================>---------]  67% / 1s  Getting aggregate ds5 (getNegativeScoresVar("D$cens", "probs", 4)) [===============>---]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getPositiveScoresVar("D$cens", "probs", 4)) [----------------------------]   0% / 0s  Getting aggregate ds1 (getPositiveScoresVar("D$cens", "probs", 4)) [==>----------------]  17% / 0s  Checking ds2 (getPositiveScoresVar("D$cens", "probs", 4)) [====>-----------------------]  17% / 0s  Getting aggregate ds2 (getPositiveScoresVar("D$cens", "probs", 4)) [=====>-------------]  33% / 0s  Checking ds3 (getPositiveScoresVar("D$cens", "probs", 4)) [========>-------------------]  33% / 0s  Getting aggregate ds3 (getPositiveScoresVar("D$cens", "probs", 4)) [=========>---------]  50% / 1s  Checking ds4 (getPositiveScoresVar("D$cens", "probs", 4)) [=============>--------------]  50% / 1s  Getting aggregate ds4 (getPositiveScoresVar("D$cens", "probs", 4)) [============>------]  67% / 1s  Checking ds5 (getPositiveScoresVar("D$cens", "probs", 4)) [==================>---------]  67% / 1s  Getting aggregate ds5 (getPositiveScoresVar("D$cens", "probs", 4)) [===============>---]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getNegativeScores("D$cens", "probs", 0.0533942701025974, 2)) [-----------]   0% / 0s  Getting aggregate ds1 (getNegativeScores("D$cens", "probs", 0.0533942701025974, 2)) [--]  17% / 0s  Checking ds2 (getNegativeScores("D$cens", "probs", 0.0533942701025974, 2)) [=>---------]  17% / 0s  Getting aggregate ds2 (getNegativeScores("D$cens", "probs", 0.0533942701025974, 2)) [>-]  33% / 0s  Checking ds3 (getNegativeScores("D$cens", "probs", 0.0533942701025974, 2)) [===>-------]  33% / 1s  Getting aggregate ds3 (getNegativeScores("D$cens", "probs", 0.0533942701025974, 2)) [>-]  50% / 1s  Checking ds4 (getNegativeScores("D$cens", "probs", 0.0533942701025974, 2)) [=====>-----]  50% / 1s  Getting aggregate ds4 (getNegativeScores("D$cens", "probs", 0.0533942701025974, 2)) [>-]  67% / 1s  Checking ds5 (getNegativeScores("D$cens", "probs", 0.0533942701025974, 2)) [======>----]  67% / 1s  Getting aggregate ds5 (getNegativeScores("D$cens", "probs", 0.0533942701025974, 2)) [=>]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getPositiveScores("D$cens", "probs", 0.0558723748401359, 2)) [-----------]   0% / 0s  Getting aggregate ds1 (getPositiveScores("D$cens", "probs", 0.0558723748401359, 2)) [--]  17% / 0s  Checking ds2 (getPositiveScores("D$cens", "probs", 0.0558723748401359, 2)) [=>---------]  17% / 0s  Getting aggregate ds2 (getPositiveScores("D$cens", "probs", 0.0558723748401359, 2)) [>-]  33% / 0s  Checking ds3 (getPositiveScores("D$cens", "probs", 0.0558723748401359, 2)) [===>-------]  33% / 0s  Getting aggregate ds3 (getPositiveScores("D$cens", "probs", 0.0558723748401359, 2)) [>-]  50% / 1s  Checking ds4 (getPositiveScores("D$cens", "probs", 0.0558723748401359, 2)) [=====>-----]  50% / 1s  Getting aggregate ds4 (getPositiveScores("D$cens", "probs", 0.0558723748401359, 2)) [>-]  67% / 1s  Checking ds5 (getPositiveScores("D$cens", "probs", 0.0558723748401359, 2)) [======>----]  67% / 1s  Getting aggregate ds5 (getPositiveScores("D$cens", "probs", 0.0558723748401359, 2)) [=>]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#> [2022-02-10 00:01:38] Finished!
