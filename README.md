...
Last time rendered: 07:59 - 09. Mar 2022 by user runner
...
#> * checking for file ‘/tmp/Rtmpra3nfT/remotes907a264e9511/datashield-dsBaseClient-d22ba51/DESCRIPTION’ ... OK
...
#> * checking for file ‘/tmp/Rtmpra3nfT/remotes907a5c04c6f3/difuture-lmu-dsPredictBase-ed79fd1/DESCRIPTION’ ... OK
...
#> * checking for file ‘/tmp/Rtmpra3nfT/remotes907a4982157a/difuture-lmu-dsCalibration-1805632/DESCRIPTION’ ... OK
...
#> * checking for file ‘/tmp/Rtmpra3nfT/remotes907a39dcecec/difuture-lmu-dsROCGLM-c951c0c/DESCRIPTION’ ... OK
#> * preparing ‘dsROCGLM’:
#> * checking DESCRIPTION meta-information ... OK
#> * checking for LF line-endings in source and make files and shell scripts
#> * checking for empty or unneeded directories
...
#> [2022-03-09 08:01:47] Your object is bigger than 1 MB (14.4 MB). Uploading larger objects may take some time.
(t0 = proc.time() - t0)
#>    user  system elapsed 
#> 108.169  53.985 765.709
datashield.symbols(conn)
#> $ds1
#> [1] "D"   "mod"
#> 
...
#> 
#> [2022-03-09 08:15:13] L2 sensitivity is: 0.016
#> 
#> [2022-03-09 08:15:17] Initializing ROC-GLM
#> 
#> [2022-03-09 08:15:17] Host: Received scores of negative response
#> [2022-03-09 08:15:17] Receiving negative scores
#> [2022-03-09 08:15:20] Host: Pushing pooled scores
#> [2022-03-09 08:15:23] Server: Calculating placement values and parts for ROC-GLM
#> [2022-03-09 08:15:27] Server: Calculating probit regression to obtain ROC-GLM
#> [2022-03-09 08:15:30] Deviance of iter1=32.6342
#> [2022-03-09 08:15:33] Deviance of iter2=40.8539
#> [2022-03-09 08:15:37] Deviance of iter3=44.5606
#> [2022-03-09 08:15:40] Deviance of iter4=44.8017
#> [2022-03-09 08:15:43] Deviance of iter5=44.8027
#> [2022-03-09 08:15:47] Deviance of iter6=44.8027
#> [2022-03-09 08:15:47] Host: Finished calculating ROC-GLM
#> [2022-03-09 08:15:47] Host: Cleaning data on server
#> [2022-03-09 08:15:50] Host: Calculating AUC and CI
#> [2022-03-09 08:16:07] Finished!
roc_glm
#> 
#> ROC-GLM after Pepe:
#> 
#>  Binormal form: pnorm(0.85 + 1.21*qnorm(t))
#> 
#>  AUC and 0.95 CI: [0.62----0.71----0.78]
roc_glm$ci
#> [1] 0.6217299 0.7777165
