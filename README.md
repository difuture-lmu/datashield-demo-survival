...
#> Skipping install of 'ds.roc.glm' from a github remote, the SHA1 (6e22e5f9) has not changed since last install.
#>   Use `force = TRUE` to force installation
```
...
#> [2022-02-10 17:57:29] Your object is bigger than 1 MB (7.2 MB). Uploading larger objects may take some time.
...
#> 
#> [2022-02-10 18:00:46] L2 sensitivity is: 0.016
#> 
...
#> 
#> [2022-02-10 18:00:47] Initializing ROC-GLM
#> 
#> [2022-02-10 18:00:47] Host: Received scores of negative response
#> 
#> [2022-02-10 18:00:47] Receiving negative scores
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [------------------------]   0% / 0s  Getting aggregate ds1 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [=>-------------]  17% / 0s  Checking ds2 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [===>--------------------]  17% / 0s  Getting aggregate ds2 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [====>----------]  33% / 0s  Checking ds3 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [=======>----------------]  33% / 1s  Getting aggregate ds3 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [=======>-------]  50% / 1s  Checking ds4 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [===========>------------]  50% / 1s  Getting aggregate ds4 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [=========>-----]  67% / 1s  Checking ds5 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [===============>--------]  67% / 1s  Getting aggregate ds5 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [===========>---]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#> [2022-02-10 18:00:48] Host: Pushing pooled scores
...
#> [2022-02-10 18:00:49] Server: Calculating placement values and parts for ROC-GLM
...
#> [2022-02-10 18:00:50] Server: Calculating probit regression to obtain ROC-GLM
...
#> [2022-02-10 18:00:51] Deviance of iter1=52.6631
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-10 18:00:52] Deviance of iter2=75.3704
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-10 18:00:53] Deviance of iter3=86.5991
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-10 18:00:54] Deviance of iter4=87.3497
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-10 18:00:55] Deviance of iter5=87.3526
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]   0% / 0s  Getting aggregate ds1 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [--]  17% / 0s  Getting aggregate ds2 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  33% / 1s  Getting aggregate ds3 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  50% / 1s  Getting aggregate ds4 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Checking ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [>-]  67% / 1s  Getting aggregate ds5 (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) []...  Aggregated (calculateDistrGLMParts(formula = y ~ x, data = "roc_data", w = "w", ) [====] 100% / 1s
#> [2022-02-10 18:00:56] Deviance of iter6=87.3526
#> [2022-02-10 18:00:56] Host: Finished calculating ROC-GLM
#> [2022-02-10 18:00:56] Host: Cleaning data on server
#> [2022-02-10 18:00:58] Host: Calculating AUC and CI
...
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [------------------------]   0% / 0s  Getting aggregate ds1 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [=>-------------]  17% / 0s  Checking ds2 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [===>--------------------]  17% / 0s  Getting aggregate ds2 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [====>----------]  33% / 0s  Checking ds3 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [=======>----------------]  33% / 1s  Getting aggregate ds3 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [=======>-------]  50% / 1s  Checking ds4 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [===========>------------]  50% / 1s  Getting aggregate ds4 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [=========>-----]  67% / 1s  Checking ds5 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [===============>--------]  67% / 1s  Getting aggregate ds5 (getNegativeScores("D$cens", "probs", 0.3, 0.2)) [===========>---]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#>    [-------------------------------------------------------------------------------------]   0% / 0s  Checking ds1 (getPositiveScores("D$cens", "probs", 0.3, 0.2)) [------------------------]   0% / 0s  Getting aggregate ds1 (getPositiveScores("D$cens", "probs", 0.3, 0.2)) [=>-------------]  17% / 0s  Checking ds2 (getPositiveScores("D$cens", "probs", 0.3, 0.2)) [===>--------------------]  17% / 0s  Getting aggregate ds2 (getPositiveScores("D$cens", "probs", 0.3, 0.2)) [====>----------]  33% / 0s  Checking ds3 (getPositiveScores("D$cens", "probs", 0.3, 0.2)) [=======>----------------]  33% / 1s  Getting aggregate ds3 (getPositiveScores("D$cens", "probs", 0.3, 0.2)) [=======>-------]  50% / 1s  Checking ds4 (getPositiveScores("D$cens", "probs", 0.3, 0.2)) [===========>------------]  50% / 1s  Getting aggregate ds4 (getPositiveScores("D$cens", "probs", 0.3, 0.2)) [=========>-----]  67% / 1s  Checking ds5 (getPositiveScores("D$cens", "probs", 0.3, 0.2)) [===============>--------]  67% / 1s  Getting aggregate ds5 (getPositiveScores("D$cens", "probs", 0.3, 0.2)) [===========>---]  83% / 1s  Aggregated (...) [=====================================================================] 100% / 1s
#> [2022-02-10 18:01:03] Finished!
